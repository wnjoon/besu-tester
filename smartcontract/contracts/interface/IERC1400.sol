...
interface IERC1400 is IERC20, IERC1643 {
    ...
    // ******************* Transfer Validity ********************
    function canTransfer(address to, uint256 value, bytes calldata data) external view returns (bytes1, bytes32); // Prior to version 0.8.0, byte used to be an alias for bytes1.
    function canTransferFrom(address from, address to, uint256 value, bytes calldata data) external view returns (bytes1, bytes32); // Prior to version 0.8.0, byte used to be an alias for bytes1.
    function canTransferByPartition(address from, address to, bytes32 partition, uint256 value, bytes calldata data) external view returns (bytes1, bytes32, bytes32); // Prior to version 0.8.0, byte used to be an alias for bytes1.
